...
public class ShowSpu extends Fragment {
    ...
    {
        ArrayList<spu> filteredList = new ArrayList<>();
        for (spu item : mExampleList) {
    ...
    private void buildRecyclerView(View view)
    {
        ...
        mExampleList =  VisionDatabase.getDatabase(getContext()).getSelect().getapspu(name);
