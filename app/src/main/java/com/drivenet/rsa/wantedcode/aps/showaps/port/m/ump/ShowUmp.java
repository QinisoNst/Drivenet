package com.drivenet.rsa.wantedcode.aps.showaps.port.m.ump;
...
public class ShowUmp extends Fragment {
    private List<ump> mExampleList;
...
return view;
    ...
    {
        ArrayList<ump> filteredList = new ArrayList<>();
        for (ump item : mExampleList) {
    ...
    private void buildRecyclerView(View view)
    {
        ...
        mExampleList =  VisionDatabase.getDatabase(getContext()).getSelect().getapsump(name);
