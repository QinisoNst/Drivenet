...
package com.drivenet.rsa.wantedcode.aps.showaps.adapter;
...
public class ExampleAdapter extends RecyclerView.Adapter<ExampleAdapter.ExampleViewHolder> {
    ...
    public static class ExampleViewHolder extends RecyclerView.ViewHolder {
        ...
        public ExampleViewHolder(View itemView) {
            ...
            mTextView2 = itemView.findViewById(R.id.aps);
    ...
    public ExampleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_item,
                parent, false);
    ...
    private void show(ExampleItem currentItem)
    {
    ...
    private void show1(ExampleItem currentItem)
    {
        if((currentItem.getText1().equals("University of Cape Town")))
        {
            MainActivity.fragmentManager.beginTransaction().replace(R.id.fragment_container, new uct()).addToBackStack(null).commit();
