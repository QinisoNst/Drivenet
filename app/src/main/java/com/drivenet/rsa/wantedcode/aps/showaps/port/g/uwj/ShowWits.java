package com.drivenet.rsa.wantedcode.aps.showaps.port.g.uwj;
...
public class ShowWits extends Fragment {
    private List<uwj> mExampleList;
    ...
    {
        ArrayList<uwj> filteredList = new ArrayList<>();
        for (uwj item : mExampleList) {
    ...
    private void buildRecyclerView(View view)
    {
        ...
        mExampleList =  VisionDatabase.getDatabase(getContext()).getSelect().getapsuwj(name);
