package com.drivenet.rsa.wantedcode.aps.showaps.port.g.smu;
...
public class ShowSmu extends Fragment {
    private List<smu> mExampleList;
...
return view;
    ...
    {
        ArrayList<smu> filteredList = new ArrayList<>();
        for (smu item : mExampleList) {
    ...
    private void buildRecyclerView(View view)
    {
        ...
        mExampleList =  VisionDatabase.getDatabase(getContext()).getSelect().getapssmu(name);
