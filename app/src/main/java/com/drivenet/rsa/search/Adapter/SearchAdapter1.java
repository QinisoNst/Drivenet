package com.drivenet.rsa.search.Adapter;
...
public class SearchAdapter1 extends RecyclerView.Adapter<SearchAdapter1.ExampleViewHolder> {
    ...
    public SearchAdapter1(ArrayList<SearchItem1> exampleList) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        SearchItem1 currentItem = mExampleList.get(position);
    ...
    private void show(SearchItem1 currentItem){
    ...
    public void filterList(ArrayList<SearchItem1> filteredList) {
