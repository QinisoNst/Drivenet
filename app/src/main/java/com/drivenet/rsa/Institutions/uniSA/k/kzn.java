package com.drivenet.rsa.Institutions.uniSA.k;
...
public class kzn extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("University of KwaZulu-Natal");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                ChildInfo detailInfo =  headerInfo.getProductList().get(childPosition);
                 ...
                 if (detailInfo.getName().contentEquals("https://www.ukzn.ac.za/"))
                {
                    String url = "https://www.ukzn.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 312 602 227"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 312 602 227" ));
    ...
    private void loadData(){
        ...
        addProduct("Campus","Durban");
        addProduct("Campus","Pietermaritzburg");
        addProduct("Campus","Pinetown");
        addProduct("Campus","Westville");


        addProduct("Contact","Tel: +27 312 602 227");





        addProduct("Faculties","Engineering and Science");
        ...
        addProduct("Website","https://www.ukzn.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/ukzn.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"UKZN Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
    ...
    {
        storageReference = firebaseStorage.getInstance().getReference();
        ref=storageReference.child("applicationform/ukzn.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
