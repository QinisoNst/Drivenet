...
public class smu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Sefako Makgatho Health Sciences University");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.smu.ac.za/"))
                {
                    String url = "https://www.smu.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 125 214 111"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 125 214 111"));
    ...
    private void loadData(){
        ...
        addProduct("Contact","Tel: +27 125 214 111");




        addProduct("Faculties","Medicine");
        addProduct("Faculties","Oral Health");
        addProduct("Faculties","Pharmacy");
        addProduct("Faculties","Health care");
        addProduct("Faculties","Science and Technology");

        addProduct("Website","https://www.smu.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/smu.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"SMU Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
