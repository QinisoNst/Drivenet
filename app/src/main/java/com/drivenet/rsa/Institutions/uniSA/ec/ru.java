...
public class ru extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Rhodes University");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                {
                    String url = "https://www.ru.ac.za/admissiongateway/";
              ...
              //      download();
                ...
                else if (detailInfo.getName().contentEquals("https://www.ru.ac.za/"))
                {
                ...
                else if (detailInfo.getName().contentEquals("Tel: +27 46 603 8148"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 46 603 8148" ));
                    startActivity(callIntent);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 46 603 8111"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"+27 46 603 8111" ));
                    startActivity(callIntent);
                }
    ...
    private void loadData(){
        ...
        addProduct("Campus","Grahamstown");


        addProduct("Contact","Tel: +27 46 603 8148");
        addProduct("Contact","Tel: +27 46 603 8111");
        ...
        addProduct("Website","https://www.ru.ac.za/");
    }
