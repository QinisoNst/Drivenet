...
public class uct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("University of Cape Town");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.uct.ac.za/"))
                {
                    String url = "https://www.uct.ac.za/";
                ...
                else if (detailInfo.getName().contentEquals("Tel: +27 216 509 111"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"+27 216 509 111" ));
                    startActivity(callIntent);
                }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/uct.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"UCT Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
