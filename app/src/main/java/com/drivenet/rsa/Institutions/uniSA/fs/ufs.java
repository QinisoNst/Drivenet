package com.drivenet.rsa.Institutions.uniSA.fs;
...
public class ufs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("University of the Free State");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.ufs.ac.za/"))
                {
                    String url = "https://www.ufs.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 514 019 111"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 514 019 111" ));
                    startActivity(callIntent);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 587 185 000"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"+27 587 185 000" ));
                    startActivity(callIntent);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 514 012 114"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"+27 514 012 114" ));
                    startActivity(callIntent);
                }
    ...
    private void loadData(){
        ...
        addProduct("Campus","Bloemfontein");
        addProduct("Campus","QwaQwa");

        addProduct("Contact","Tel: +27 514 019 111");
        addProduct("Contact","Tel: +27 587 185 000");
        addProduct("Contact","Tel: +27 514 012 114");
        ...
        addProduct("Faculties","Natural and Agricultural Sciences");
        addProduct("Faculties","Humanities and Theology");

        addProduct("Website","https://www.ufs.ac.za/");
    }
    ...
    private void download1()
    {
        ...
        ref=storageReference.child("applicationform/ufs.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"UFS Course Form",".pdf",DIRECTORY_DOWNLOADS,url);
            }
