...
public class uj extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("University of Johannesburg");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.uj.ac.za/"))
                {
                    String url = "https://www.uj.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 115 594 555"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 115 594 555" ));
                    startActivity(callIntent);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 115 592 911"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"+27 115 592 911" ));
                    startActivity(callIntent);
                }
    ...
    private void loadData(){
        ...
        addProduct("Campus","Soweto");

        addProduct("Contact","Tel: +27 115 594 555");
        addProduct("Contact","Tel: +27 115 592 911");



        addProduct("Faculties","Art");
        addProduct("Faculties","Design and Architecture");
        addProduct("Faculties","Educationy");
        ...
        addProduct("Website","https://www.uj.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/uj.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"UJ Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
