...
public class ProvAdapter1 extends RecyclerView.Adapter<ProvAdapter1.ExampleViewHolder> {
    ...
    public ProvAdapter1(ArrayList<ProvItem1> exampleList , Context context) {
    ...
    public ExampleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_item4,
                parent, false);
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ProvItem1 currentItem = mExampleList.get(position);
    ...
    public void filterList(ArrayList<ProvItem1> filteredList) {
        mExampleList = filteredList;
        notifyDataSetChanged();
    }
    private void show(ProvItem1 currentItem){
