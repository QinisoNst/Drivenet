...
public class ul extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("University of Limpopo");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.ul.ac.za/"))
                {
                    String url = "https://www.ul.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 152 682 140"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 152 682 140" ));
    ...
    private void loadData(){
        ...
        addProduct("Campus","Turfloop");


        addProduct("Contact","Tel: +27 152 682 140");
        ...
        addProduct("Faculties","Management and Law");
        addProduct("Faculties","Health Sciences");
        addProduct("Faculties","Science And Agriculture");

        addProduct("Website","https://www.ul.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/ul.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"UL Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
