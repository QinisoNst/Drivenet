...
public class tut extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Tshwane University of Technologyy");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.tut.ac.za/"))
                {
                    String url = "https://www.tut.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 861 102 421"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 861 102 421" ));
                    startActivity(callIntent);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 123 825 911"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 123 825 911" ));
                    startActivity(callIntent);
                }
    ...
    private void loadData(){
        ...
        addProduct("Campus","Pretoria");
        addProduct("Campus","Mbombela");
        addProduct("Campus","Polokwane");
        addProduct("Campus","Ga-Rankuwa");
        addProduct("Campus","Soshanguve");
        addProduct("Campus","Witbank");


        addProduct("Contact","Tel: +27 861 102 421");
        addProduct("Contact","Tel: +27 123 825 911");


        addProduct("Faculties","Art");
        addProduct("Faculties","Design and Architecture");
        addProduct("Faculties","Education");
        addProduct("Faculties","Engineering and the Built Environment,");
        addProduct("Faculties","Economic and Financial Sciences");
        addProduct("Faculties","Science");
        addProduct("Faculties","Health Sciences, Humanities");
        addProduct("Faculties","Law");
        addProduct("Faculties","Management");

        addProduct("Website","https://www.tut.ac.za/");
    }
    ...
    private void download1()
    {
        ...
        ref=storageReference.child("applicationform/tut.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"TUT Course Form",".pdf",DIRECTORY_DOWNLOADS,url);
            }
