...
public class vut extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Vaal University of Technology");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.vut.ac.za/"))
                {
                    String url = "https://www.vut.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 169 509 000"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 169 509 000" ));
    ...
    private void loadData(){
        ...
        addProduct("Campus","Secunda");
        addProduct("Campus","Klerksdorp");
        addProduct("Campus","Upington");


        addProduct("Contact","Tel: +27 169 509 000");



        addProduct("Faculties","Engineering and Technology");
        addProduct("Faculties","Applied & Computer Sciences");
        addProduct("Faculties","Human Sciences");
        addProduct("Faculties","Management Sciences");

        addProduct("Website","https://www.vut.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/vut.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"VUT Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
