...
public class cut extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Central University of Technology Free State");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("www.cut.ac.za"))
                {
                    String url = "https://www.cut.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 515 073 911"))
                    {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 515 073 911" ));
    ...
    private void loadData(){
        ...
        addProduct("Campus","Welkom");

        addProduct("Contact","Tel: +27 515 073 911");


        addProduct("Faculties","Engineering and Information Technology");
        addProduct("Faculties","Health and Environmental Sciences");
        addProduct("Faculties","Humanities");
        addProduct("Faculties","Management Sciences");

        addProduct("Website","www.cut.ac.za");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/cut.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"CUT Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
    ...
    {
        storageReference = firebaseStorage.getInstance().getReference();
        ref=storageReference.child("applicationform/cut.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"CUT Course Form",".pdf",DIRECTORY_DOWNLOADS,url);
            }
