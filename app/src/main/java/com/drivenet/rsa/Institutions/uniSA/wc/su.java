...
public class su extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Stellenbosch University");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.su.ac.za/"))
                {
                    String url = "https://www.su.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 21 808 9111"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 21 808 9111" ));
    ...
    private void loadData(){
        ...
        addProduct("Campus","Stellenbosch");
        addProduct("Campus","Saldanha Bay");
        addProduct("Campus","Bellville");
        addProduct("Campus","Tygerberg");


        addProduct("Contact","Tel: +27 21 808 9111");


        addProduct("Faculties","AgriScience");
        addProduct("Faculties","Arts and Social Science");
        addProduct("Faculties","Education");
        addProduct("Faculties","Engineering");
        addProduct("Faculties","Law");
        addProduct("Faculties","Science");
        addProduct("Faculties","Theology");
        addProduct("Faculties","Economic and Management Science");
        addProduct("Faculties","Health Science");
        addProduct("Faculties","Business");

        addProduct("Website","https://www.su.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/su.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"SU Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
    ...
    {
        storageReference = firebaseStorage.getInstance().getReference();
        ref=storageReference.child("applicationform/su.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"SU Course Form",".pdf",DIRECTORY_DOWNLOADS,url);
            }
