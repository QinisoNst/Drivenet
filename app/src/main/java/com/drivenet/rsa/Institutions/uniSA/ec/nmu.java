...
public class nmu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Nelson Mandela University");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.mandela.ac.za/"))
                {
                    String url = "https://www.mandela.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 41 504 2075"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"+27 41 504 2075" ));
                    startActivity(callIntent);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 41 504 1111"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"+27 41 504 1111" ));
                    startActivity(callIntent);
                }
    ...
    private void loadData(){
        ...
        addProduct("Campus","George");
        addProduct("Campus","Port Elizabeth");

        addProduct("Contact","Tel: +27 41 504 2075");
        addProduct("Contact","Tel: +27 41 504 1111");


        addProduct("Faculties","Arts");
        addProduct("Faculties","Built Environment & IT");
        addProduct("Faculties","Business and Economic Science");
        ...
        addProduct("Website","https://www.mandela.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/nmu.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"NMU Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
