package com.drivenet.rsa.Institutions.uniSA.ec;
...
public class ufh extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("University of Fort Hare");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.ufh.ac.za/"))
                {
                ...
                else if (detailInfo.getName().contentEquals("Tel: +27 40 653 2312"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 40 653 2312" ));
                    startActivity(callIntent);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 40 602 2011"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"+27 40 602 2011" ));
                    startActivity(callIntent);
                }
                else if (detailInfo.getName().contentEquals("Online Course"))
                {
                    String url = "https://www.ufh.ac.za/apply/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
    ...
    private void loadData(){
        ...
        addProduct("Campus","Alice");
        addProduct("Campus","East London");
        addProduct("Campus","Bhisho");

        addProduct("Contact","Tel: +27 40 653 2312");
        addProduct("Contact","Tel: +27 40 602 2011");



        addProduct("Faculties","Education");
        addProduct("Faculties","Science & Agriculture");
        addProduct("Faculties","Social Sciences & Humanities");
        addProduct("Faculties","Management & Commerce");
        addProduct("Faculties","Law");

        addProduct("Website","https://www.ufh.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/ufh.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"UFH Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
