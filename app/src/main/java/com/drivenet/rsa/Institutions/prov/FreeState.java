...
public class FreeState extends Fragment {
    ...
    private void createExampleList()
    {
        ...
        mExampleList.add(new ProvItem1("Central University of Technology"));
        mExampleList.add(new ProvItem1("University of the Free State"));
    }
