...
public class unizulu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("University of Zululand");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.unizulu.ac.za/"))
                {
                    String url = "https://www.unizulu.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 359 026 624"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 35 902 6624" ));
    ...
    private void loadData(){
        ...
        addProduct("Campus","Empangeni");
        addProduct("Campus","Richards bay");

        addProduct("Contact","Tel: +27 359 026 624");
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/unizulu.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"UniZulu Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
