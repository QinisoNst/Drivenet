...
public class dut extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Durban University of Technology");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("www.dut.ac.za"))
                {
                ...
                else if (detailInfo.getName().contentEquals("Tel: +27 312 042 111"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 312 042 111" ));
    ...
    private void loadData()
    {
        ...
        addProduct("Contact","Tel: +27 312 042 111");


        addProduct("Faculties","Applied Sciences");
        addProduct("Faculties","Accounting & Informatics");
        addProduct("Faculties","Arts and Design");
        ...
        addProduct("Website","www.dut.ac.za");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/dut.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"DUT Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
    ...
    {
        storageReference = firebaseStorage.getInstance().getReference();
        ref=storageReference.child("applicationform/dut.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
