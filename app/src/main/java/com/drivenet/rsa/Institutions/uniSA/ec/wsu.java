...
public class wsu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Walter Sisulu University for Technology");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.wsu.ac.za/"))
                {
                    String url = "https://www.wsu.ac.za/";
                ...
                else if (detailInfo.getName().contentEquals("Tel: +27 475 022 200"))
                {
                    ...
                    callIntent.setData(Uri.parse( "tel:"+"+27 475 022 200" ));
    ...
    private void loadData(){
        ...
        addProduct("Faculties","Management Sciences & Law");
        addProduct("Faculties","Science");

        addProduct("Website","https://www.wsu.ac.za/");
    }
    ...
    private void download1()
    {
        ...
        ref=storageReference.child("applicationform/wsu.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"WSU Course Form",".pdf",DIRECTORY_DOWNLOADS,url);
            }
