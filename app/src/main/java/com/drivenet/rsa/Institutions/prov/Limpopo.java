...
public class Limpopo extends Fragment {
    ...
    private void createExampleList()
    {
        ...
        mExampleList.add(new ProvItem1("University of Limpopo"));
        mExampleList.add(new ProvItem1("University of Venda"));
    }
