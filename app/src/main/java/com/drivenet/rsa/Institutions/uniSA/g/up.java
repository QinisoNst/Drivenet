...
public class up extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("University of Pretoria");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.up.ac.za/"))
                {
                    String url = "https://www.up.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel:  +27 124 204 111"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+"  +27 124 204 111" ));
    ...
    private void loadData(){
        ...
        addProduct("Contact","Tel: +27 124 204 111");
        ...
        addProduct("Faculties","Medicine & Health");
        addProduct("Faculties","Engineering");
        addProduct("Faculties","Science & Technology");

        addProduct("Website","https://www.up.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"UP Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
