...
public class KwaZuluNatal extends Fragment {
    ...
    private void createExampleList()
    {
        ...
        mExampleList.add(new ProvItem1("Durban University of Technology"));
        mExampleList.add(new ProvItem1("University of KwaZulu-Natal"));
        mExampleList.add(new ProvItem1("Mangosuthu University of Technology"));
        mExampleList.add(new ProvItem1("University of Zululand"));
