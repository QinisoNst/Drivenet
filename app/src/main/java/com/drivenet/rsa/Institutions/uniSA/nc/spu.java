package com.drivenet.rsa.Institutions.uniSA.nc;
...
public class spu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        univ.setText("Sol Plaatje University");
        ...
        simpleExpandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                else if (detailInfo.getName().contentEquals("https://www.spu.ac.za/"))
                {
                    String url = "https://www.spu.ac.za/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
                }
                else if (detailInfo.getName().contentEquals("Tel: +27 53 491 000"))
                {
                    Intent callIntent = new Intent(Intent.ACTION_DIAL);
                    callIntent.setData(Uri.parse( "tel:"+" +27 53 491 000" ));
    ...
    private void loadData()
    {
        ...
        addProduct("Campus","Kimberley");

        addProduct("Contact","Tel: +27 53 491 000");



        addProduct("Faculties","Natural and Applied Science");
        addProduct("Faculties","Economic and Management Science");
        addProduct("Faculties","Education");
        addProduct("Faculties","Humanties");

        addProduct("Website","https://www.spu.ac.za/");
    }
    ...
    private void download()
    {
        ...
        ref=storageReference.child("university/spu.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"SPU Prospectus",".pdf",DIRECTORY_DOWNLOADS,url);
            }
    ...
    {
        storageReference = firebaseStorage.getInstance().getReference();
        ref=storageReference.child("applicationform/spu.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri)
            {
                String url = uri.toString();
                downloadfiles(getContext(),"SPU Course Form",".pdf",DIRECTORY_DOWNLOADS,url);
            }
