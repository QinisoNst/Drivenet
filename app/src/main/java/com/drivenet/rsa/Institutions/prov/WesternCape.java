...
public class WesternCape extends Fragment {
    ...
    private void createExampleList()
    {
        ...
        mExampleList.add(new ProvItem1("University of Cape Town"));
        mExampleList.add(new ProvItem1("University of the Western Cape"));
        mExampleList.add(new ProvItem1("Stellenbosch University"));
        mExampleList.add(new ProvItem1("Cape Peninsula University of Technology"));
    }
